    ...
    function init() {
      ...
      function flugzeugRoute(ctx) {
        ...
        ctx.save();
        ctx.beginPath();
        ctx.moveTo(382.7, 90.1);
        ctx.bezierCurveTo(393.5, 86.5, 517.0, 87.2, 593.3, 163.6);
        ctx.lineWidth = 0.5;
        ctx.stroke();
  
        // flugzeugRoute/Pfad
        ctx.beginPath();
        ctx.moveTo(97.3, 164.1);
        ctx.bezierCurveTo(168.3, 103.4, 271.7, 68.5, 382.7, 90.1);
        ctx.stroke();
  
        // flugzeugRoute/Pfad
        ctx.beginPath();
        ctx.moveTo(382.3, 90.5);
        ctx.bezierCurveTo(393.2, 86.9, 524.1, 144.2, 485.4, 300.5);
        ctx.stroke();
        ctx.restore();
      }
